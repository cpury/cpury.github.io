...
<div class="warning">
    <b>Warning!</b> This post contains a bit of language that might be offensive to you. Oh and the resulting game is, well, entirely immature and horrible. Proceed at your own risk!
</div>
...
This is when I saw a post on Reddit about [creating Cards Against Humanity cards using a Char-LSTM](https://www.reddit.com/r/MachineLearning/comments/bpvif8/p_generating_cards_against_humanity_cards/). Having the humor and intellectual maturity of a 14-year-old and thus being a natural fan of CAH, I loved the idea! So, apologizing to [u/ablacklama](https://www.reddit.com/user/ablacklama/) for taking his idea, I fine-tuned a GPT-2 model on CAH cards and checked out the results. They were hilarious! Here are some early examples:
...
Let me know what you think and if you have any other ideas you’d like to see 🙂
